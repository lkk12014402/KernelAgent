...
from kernel_perf_agent.kernel_opt.utils.proxy_util import devgpu_proxy_setup
...
class Retriever:
    ...
    def __init__(
        ...
        # Configure the proxy
        self._original_proxy_env = devgpu_proxy_setup()

    def doc_preprocess(self):
        """Preprocess the documents."""
        # Langchain
        # =========================================
        # DirectoryLoader
        dir_loader = DirectoryLoader("../kernel_opt/database/", recursive=True)
...
"""
            ...
            #     debug_similarity_path = (
            #         self.module_path / "debug_output" / "similarity_score.log"
            #     )
            #     with open(str(debug_similarity_path), "w") as file:
            #         file.write(debug_str)
            #         # for key, value in opt_similarity_sorted:
            #         # file.write("\n---------------------------------\n")
            #         # file.write(key.opt_desc)
            #         # file.write("\n---------------------------------\n")
